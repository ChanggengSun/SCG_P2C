...
# Keep legacy name for compatibility with generic Runner usage.
...
train_cfg = dict(
    _delete_=True,
    type='JointSeq5IndependentDualTrainLoop',
    flow_dataloader=flow_train_dataloader,
    track_dataloader=track_train_dataloader,
